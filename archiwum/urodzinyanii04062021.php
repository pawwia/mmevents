...
<div class="col-lg-12 col-sm-12 col-xs-12 d"  id="xdstart">
...
<div class="col-md-1 col-xs-12"></div>
	...
	<div class="podziekowanie">
        <h2>Co to była za impreza!</h2><br>
		Mamy nadzieję, że nasze fotolustro przypadło Ci do gustu :) <br>
		Jeśli chcesz pomóc innym podjąć dobrą decyzę co do wyboru właściwej firmy, zostaw nam swoją opinie:<br>
		<p style="color:red; display:none;">Minimalna ważność galerii: 29.04.2022<br>
		Zdjęcia do tej galerii jeszcze nie zostały dodane :( Daj nam trochę czasu lub skontaktuj się z nami :) </p>
		<div class="allbuts">
		<a  href="https://g.page/r/CZ5IqhTgmx-xEB0/review" style="background-color:#F4B400; color:white "class="dziekiopinia col-lg-3 col-md-6 col-xs-12 ">Google </a>
		<a  href="https://www.facebook.com/mmevents.fotolustro/reviews/?ref=page_internal" style="background-color:#3b5998; color:white" class="dziekiopinia col-lg-3 col-md-6 col-xs-12">Facebook </a>
		<a  href="https://wedding.pl/fotobudka/magic-moments-events-fotolustro-szczecin/ocen" style="background-color:#6e0137; color:white" class="dziekiopinia col-lg-3 col-md-6 col-xs-12">Wedding.pl </a>
		<a  href="https://www.weselezklasa.pl/ogloszenia-weselne/fotolustro-fotobudka-magic-moments-events-mmevents,51144/" style="background-color:#9f1e6f; color:white" class="dziekiopinia col-lg-3 col-md-6 col-xs-12">Wesele z klasą </a>

</div>

		
		</div>
        <div class="row cppa" id="miejsce" style="margin-left:auto; margin-right:auto;">
...
<?php } 
	...
	header("Location: https://mmevents.pl/galeria.php?wiad=1");
